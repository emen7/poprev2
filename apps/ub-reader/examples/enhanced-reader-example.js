...
export default function EnhancedReaderExample() {
    ...
    return (_jsx("div", { className: "enhanced-reader-example", children: _jsx(Reader, { document: exampleDocument, config: exampleConfig }) }));
}
//# sourceMappingURL=enhanced-reader-example.js.map