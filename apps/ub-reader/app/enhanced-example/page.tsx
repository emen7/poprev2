...
export default function EnhancedExamplePage() {
  return (
    <EnhancedReader title="Enhanced Reader Example">
      ...
      <p>
        This is an example of the Enhanced Reader component with improved navigation and settings features.
        The component provides a modern, responsive interface for reading content.
      </p>
      ...
      <ul>
        <li>
          <strong>Navigation Panel</strong> - Click the hamburger menu (☰) in the top-left corner to open the navigation panel.
        </li>
        <li>
          <strong>Settings Panel</strong> - Click the gear icon (⚙️) in the top-right corner to open the settings panel.
        </li>
        <li>
          <strong>Theme Switching</strong> - Change between light and dark themes in the settings panel.
        </li>
        <li>
      ...
      <p>
        In future updates, the Enhanced Reader will include:
      </p>
      ...
      <p>
        Click the hamburger menu (☰) and gear icon (⚙️) to explore the navigation and settings panels.
        Try switching between light and dark themes to see how the interface adapts.
      </p>
    </EnhancedReader>
  );
}