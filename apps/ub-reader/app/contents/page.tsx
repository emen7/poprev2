...
export default function ContentsPage() {
  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="mb-6 text-3xl font-bold">The Urantia Book - Contents</h1>
              ...
              <div key={paper.number} className="border-t pt-4 first:border-t-0 first:pt-0">
                ...
                <div className="flex flex-wrap">
                  ...
                  {createSectionColumns(paper.sections).map((column, colIndex) => (
                    <div key={colIndex} className="mb-4 w-full sm:w-1/2 lg:w-1/3 xl:w-1/4">
  ...
  return (
    <div className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
      <div className="mx-auto max-w-4xl">
        <h2 className="mb-6 text-center text-2xl font-semibold">CONTENTS OF THE BOOK</h2>
                    ...
                    <tbody>
                      {paper.sections.map(section => (
                        <tr key={section.number}>
                          <td className="w-16 pr-4 text-right align-top">
                            <Link
                              href={`/traditional-reader/${paper.number}#section${section.number}`}
                              className="text-blue-600 hover:underline"
                            >
