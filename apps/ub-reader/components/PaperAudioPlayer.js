 ...
 */
export default function PaperAudioPlayer({ paper }) {
    ...
    return _jsx(AudioPlayer, { content: content, title: `Listen to Paper ${paper.number}` });
}
//# sourceMappingURL=PaperAudioPlayer.js.map