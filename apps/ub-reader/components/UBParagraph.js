 ...
 */
export const UBParagraph = ({ paragraph, isTopicChange = false, className = '', currentPaper = 0, }) => {
    ...
    return (_jsxs("div", { className: paragraphClasses, id: `p-${paragraph.number}`, ref: paragraphRef, onMouseUp: handleMouseUp, children: [showParagraphNumbers && _jsx("span", { className: "ub-paragraph-number", children: paragraph.number }), _jsx("div", { className: "ub-paragraph-text", children: _jsx(ReferenceProcessor, { content: processText(paragraph.text), currentPaper: currentPaper, baseUrl: "/paper", showTooltips: true, onReferenceClick: handleReferenceClick }) })] }));
};
export default UBParagraph;
//# sourceMappingURL=UBParagraph.js.map