 ...
 */
export function parseUBReferences(text) {
    const references = [];
 ...
 */
export function applyReferenceContext(references, currentPaper) {
 ...
 */
export function generateUBReferenceUrl(reference, baseUrl = '/paper') {
 ...
 */
export function isValidReference(reference, maxPapers = 196, maxSections, maxParagraphs) {
    // Check paper number
 ...
 */
export function replaceUBReferencesWithLinks(text, baseUrl = '/paper', currentPaper = 0) {
 ...
 */
export function formatReference(reference, format = 'short') {
    switch (format) {
        case 'full':
