...
const getForeword = async () => {
  ...
  return {
    ...
    paragraphs: [
      {
        number: 1,
        text: 'In the minds of the mortals of Urantia—that being the name of your world—there exists great confusion respecting the meaning of such terms as God, divinity, and deity. Human beings are still more confused and uncertain about the relationships of the divine personalities designated by these numerous appellations.',
      },
      {
        number: 2,
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="ub-paper">
        ...
        {foreword.author && (
          <div className="ub-paper-author">Presented by: {foreword.author}</div>
        )}
        
        <div className="ub-section-paragraphs">
          {foreword.paragraphs.map((paragraph) => (
            <div key={paragraph.number} className="ub-paragraph" id={`p-${paragraph.number}`}>
