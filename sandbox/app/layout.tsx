      ...
      <body>
        <nav className="bg-gray-800 text-white p-4">
          <div className="container mx-auto flex justify-between items-center">
            <a href="/" className="text-xl font-bold">PopRev2 Sandbox</a>
            <div className="space-x-4">
              <a href="/example" className="hover:text-gray-300">Example</a>
              <a href="/test" className="hover:text-gray-300">Scientific Test</a>
