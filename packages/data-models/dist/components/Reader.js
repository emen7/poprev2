...
export function Reader({ document, config = {}, className = '', style = {} }) {
  ...
  if (!internalDocument) {
    return _jsx('div', {
      ...
      style: style,
      children: _jsx('div', { className: 'reader-loading', children: 'Loading document...' }),
    });
  }
  ...
  const readerStyles = Object.assign(
    {
      ...
      '--reader-background-color':
        readerConfig.theme.mode === 'dark'
          ? ((_a = readerConfig.theme.colors) === null || _a === void 0 ? void 0 : _a.background) ||
            '#1a202c'
          : ((_b = readerConfig.theme.colors) === null || _b === void 0 ? void 0 : _b.background) ||
            '#ffffff',
      '--reader-text-color':
        readerConfig.theme.mode === 'dark'
          ? ((_c = readerConfig.theme.colors) === null || _c === void 0 ? void 0 : _c.text) ||
            '#e2e8f0'
          : ((_d = readerConfig.theme.colors) === null || _d === void 0 ? void 0 : _d.text) ||
            '#333333',
      '--reader-border-color':
        readerConfig.theme.mode === 'dark'
          ? ((_e = readerConfig.theme.colors) === null || _e === void 0 ? void 0 : _e.border) ||
            '#4a5568'
          : ((_f = readerConfig.theme.colors) === null || _f === void 0 ? void 0 : _f.border) ||
            '#e2e8f0',
      '--reader-panel-background':
        readerConfig.theme.mode === 'dark'
          ? ((_g = readerConfig.theme.colors) === null || _g === void 0
              ? void 0
              : _g.panelBackground) || '#2d3748'
          : ((_h = readerConfig.theme.colors) === null || _h === void 0
              ? void 0
              : _h.panelBackground) || '#f7fafc',
      // Typography
      '--reader-font-family':
        ...
        children: [
          (readerConfig.navigation.showTableOfContents ||
            ...
            _jsx('div', {
              ...
              children: _jsx(ReaderNavigation, {
                document: internalDocument,
                config: readerConfig,
                activeSection: activeSection,
                onSectionSelect: setActiveSection,
