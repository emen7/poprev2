  ...
  return _jsxs(_Fragment, {
    children: [
      _jsx('button', {
        ...
        children: _jsx('i', { className: `fas ${isOpen ? 'fa-times' : 'fa-bars'}` }),
      }),
      _jsxs('div', {
        ref: navPanelRef,
        ...
        children: [
          _jsx('div', {
            className: 'reader-nav-fixed-top',
            children: parts
                  ...
                  'div',
                  {
                    children: [
                      _jsxs('button', {
                        ...
                        children: [part.title, _jsx('i', { className: 'fas fa-chevron-down' })],
                      }),
                      expandedParts.includes(part.id) &&
                        _jsx('div', {
                          className: 'reader-part-content',
                          children: _jsx('ul', {
                            className: 'reader-nav-list',
                            children: part.papers.map(paper =>
                              _jsx(
                                'li',
                                {
          ...
          _jsx('div', { className: 'reader-nav-scrollable' }),
          _jsx('div', {
            className: 'reader-nav-fixed-bottom',
            children: parts
              .filter(part => part.id !== activePart)
              .map(part =>
                _jsxs(
      ...
      _jsxs('div', {
        className: `reader-navigation ${className}`,
        children: [
          config.navigation.showBreadcrumbs &&
            _jsxs('div', {
              className: 'reader-breadcrumbs',
              children: [
                _jsx('span', { className: 'reader-breadcrumb-item', children: 'Home' }),
                _jsx('span', { className: 'reader-breadcrumb-separator', children: '/' }),
                _jsx('span', { className: 'reader-breadcrumb-item', children: document.title }),
                activeSection &&
                  _jsxs(_Fragment, {
                    children: [
                      _jsx('span', { className: 'reader-breadcrumb-separator', children: '/' }),
                      _jsx('span', {
                        className: 'reader-breadcrumb-item',
                        children: findSectionTitle(document, activeSection),
                      }),
                    ],
                  }),
              ],
          ...
          config.navigation.showTableOfContents &&
            _jsxs('div', {
              ...
              children: [
                _jsx('h3', { className: 'reader-toc-title', children: 'Table of Contents' }),
                _jsx('ul', {
                  className: 'reader-toc-list',
          ...
          config.navigation.showRelationshipMap &&
            document.relationships.length > 0 &&
            _jsxs('div', {
              className: 'reader-relationship-map',
              children: [
                _jsx('h3', {
                  className: 'reader-relationship-map-title',
                  children: 'Related Documents',
                }),
                _jsx('ul', {
                  className: 'reader-relationship-list',
                  children: document.relationships.map((relationship, index) =>
                    _jsxs(
                      'li',
                      {
                        className: 'reader-relationship-item',
                        children: [
                          _jsx('span', {
                            className: 'reader-relationship-type',
                            children: relationship.type,
                          }),
                          _jsx('span', {
                            className: 'reader-relationship-target',
                            children: relationship.targetDocumentId,
                          }),
                          relationship.description &&
                            _jsx('span', {
                              className: 'reader-relationship-description',
...
function TableOfContentsItem({ section, activeSection, onSectionSelect, level }) {
  ...
  return _jsxs('li', {
    className: `reader-toc-item reader-toc-level-${level} ${isActive ? 'active' : ''}`,
    children: [
      _jsx('a', {
        href: `#${section.id}`,
