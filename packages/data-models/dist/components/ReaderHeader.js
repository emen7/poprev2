...
export function ReaderHeader({ document, config, className = '' }) {
  ...
  return _jsxs('div', {
    className: `reader-header ${className}`,
    children: [
      config.branding.logo &&
        _jsx('div', {
          ...
          children: _jsx('img', {
            ...
            alt: config.branding.appName || 'Reader',
          }),
        }),
      _jsxs('div', {
        className: 'reader-title-container',
        children: [
          _jsx('h1', {
          ...
          document.metadata.subtitle &&
            _jsx('h2', { className: 'reader-subtitle', children: document.metadata.subtitle }),
        ],
      }),
      _jsxs('div', {
        className: 'reader-metadata',
        children: [
          ...
          document.metadata.date &&
            _jsx('div', { className: 'reader-date', children: document.metadata.date }),
          document.metadata.categories &&
            document.metadata.categories.length > 0 &&
            _jsxs('div', {
              className: 'reader-categories',
      ...
      config.navigation.linkbackUrl &&
        _jsx('div', {
          className: 'reader-linkback',
          children: _jsx('a', {
            href: config.navigation.linkbackUrl,
            children: config.navigation.linkbackText || 'Back',
          }),
        }),
    ],
  });
