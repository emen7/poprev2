...
export class DocumentAdapter {
    ...
    static convertMetadata(metadata) {
        return Object.assign({ title: metadata.title, subtitle: metadata.subtitle, author: metadata.author, date: metadata.date, categories: metadata.categories, tags: metadata.tags, relatedContent: metadata.relatedContent }, metadata);
    }
    /**
     * Extract sections from the content
     *
