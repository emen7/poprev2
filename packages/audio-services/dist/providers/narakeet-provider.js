...
export class NarakeetProvider {
   ...
   */
  constructor(apiKey, apiEndpoint = 'https://api.narakeet.com/text-to-speech/mp3') {
    this.apiKey = apiKey;
 ...
 */
export function createNarakeetProvider(apiKey) {
  return new NarakeetProvider(apiKey);
}
//# sourceMappingURL=narakeet-provider.js.map
