 ...
 */
export const urantiaPronunciations = [
  {
    term: 'Andovontia',
    ipa: 'an-do-VON-sha',
 ...
 */
export function searchPronunciations(partialTerm) {
 ...
 */
export function getPronunciationsByCategory(category) {
  return urantiaPronunciations.filter(entry => entry.category === category);
}
//# sourceMappingURL=urantia-terms.js.map
