 ...
 */
import { generateAudio, setDefaultProvider, TTSProvider, tagContentWithPronunciation, extractUrantiaTerms, } from '../src';
...
async function example1() {
    ...
    const result = await generateAudio('Urantia is the name given to your world, and it is of origin in Nebadon.');
