...
async function runExample() {
    try {
        ...
        console.log(`Title: ${paper1 === null || paper1 === void 0 ? void 0 : paper1.title}`);
        console.log(`Author: ${paper1 === null || paper1 === void 0 ? void 0 : paper1.author}`);
        console.log(`Sections: ${paper1 === null || paper1 === void 0 ? void 0 : paper1.sections.length}`);
        // Get a specific section
        const section = await documentRepository.getSectionById('paper1', 'paper1-section1');
        console.log(`\nDetails for section 'paper1-section1':`);
        console.log(`Title: ${section === null || section === void 0 ? void 0 : section.title}`);
        console.log(`Paragraphs: ${section === null || section === void 0 ? void 0 : section.paragraphs.length}`);
        // Get a specific paragraph
        const paragraph = await documentRepository.getParagraphById('paper1', 'paper1-section1', 'paper1-section1-paragraph1');
        console.log(`\nDetails for paragraph 'paper1-section1-paragraph1':`);
        console.log(`Number: ${paragraph === null || paragraph === void 0 ? void 0 : paragraph.number}`);
        console.log(`Text: ${paragraph === null || paragraph === void 0 ? void 0 : paragraph.text}`);
        ...
        Object.entries(stats.entities).forEach(([name, info]) => {
