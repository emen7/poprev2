...
export class HighlightManager {
    ...
    handleCopy(event) {
        ...
        (_a = event.clipboardData) === null || _a === void 0 ? void 0 : _a.setData('text/plain', processedText);
    ...
    addStyles() {
        ...
        if (document.getElementById('ub-highlight-styles'))
            return;
        ...
        copyButton.addEventListener('click', () => {
            ...
            if (selection && !selection.isCollapsed) {
                ...
                navigator.clipboard
                    ...
                    .then(() => {
                    alert(`Copied: "${processedText.substring(0, 30)}${processedText.length > 30 ? '...' : ''}"`);
                })
                    .catch(err => {
                ...
                navigator.clipboard
                    ...
                    .then(() => {
                    alert(`Copied: "${this.selectedText.substring(0, 30)}${this.selectedText.length > 30 ? '...' : ''}"`);
                })
                    .catch(err => {
                    console.error('Failed to copy text:', err);
                });
    ...
    showColorPicker(position) {
        ...
        this.colors.forEach(color => {
            ...
            if (this.isDarkMode() && color.lightModeOnly)
                return;
            if (!this.isDarkMode() && color.darkModeOnly)
                return;
            ...
            (_a = this.colorPicker) === null || _a === void 0 ? void 0 : _a.appendChild(colorOption);
        });
    ...
    processContentsForHighlighting(contents, className) {
        ...
        textNodes.forEach(textNode => {
            ...
            if (parent && ((_a = parent.classList) === null || _a === void 0 ? void 0 : _a.contains('ub-highlight'))) {
            ...
            parent === null || parent === void 0 ? void 0 : parent.insertBefore(highlightSpan, textNode);
    ...
    removeHighlightsInRange(range) {
        ...
        textNodes.forEach(textNode => {
            ...
            if (parent && ((_a = parent.classList) === null || _a === void 0 ? void 0 : _a.contains('ub-highlight'))) {
                ...
                (_b = parent.parentNode) === null || _b === void 0 ? void 0 : _b.insertBefore(textNode, parent);
                (_c = parent.parentNode) === null || _c === void 0 ? void 0 : _c.removeChild(parent);
            }
        });
