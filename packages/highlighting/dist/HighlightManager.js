...
export class HighlightManager {
  ...
  handleCopy(event) {
    ...
    (_a = event.clipboardData) === null || _a === void 0
      ? void 0
      : _a.setData('text/plain', processedText);
    ...
    copyButton.addEventListener('click', () => {
      ...
      if (selection && !selection.isCollapsed) {
        ...
        navigator.clipboard
          ...
          .then(() => {
            alert(
              `Copied: "${this.selectedText.substring(0, 30)}${this.selectedText.length > 30 ? '...' : ''}"`
            );
          })
          .catch(err => {
            console.error('Failed to copy text:', err);
  ...
  processContentsForHighlighting(contents, className) {
    ...
    textNodes.forEach(textNode => {
      ...
      if (
        parent &&
        ((_a = parent.classList) === null || _a === void 0 ? void 0 : _a.contains('ub-highlight'))
      ) {
  ...
  removeHighlightsInRange(range) {
    ...
    textNodes.forEach(textNode => {
      ...
      if (
        ...
        (_b = parent.parentNode) === null || _b === void 0
          ? void 0
          : _b.insertBefore(textNode, parent);
