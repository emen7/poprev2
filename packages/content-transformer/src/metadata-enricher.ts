...
import { DocumentNode, RootNode, DocumentMetadata } from './types';
 ...
 */
export async function enrichMetadata(content: any, options: any = {}): Promise<any> {
 ...
 */
function extractMetadataFromContent(rootNode: RootNode): DocumentMetadata {
 ...
 */
function findFirstHeading(rootNode: RootNode): DocumentNode | undefined {
 ...
 * @returns The first heading node, or undefined if none found
 */
function findFirstHeadingRecursive(node: DocumentNode): DocumentNode | undefined {
 ...
 */
function extractCategoriesAndTags(rootNode: RootNode): { categories: string[]; tags: string[] } {
 ...
 */
function extractDateFromContent(rootNode: RootNode): string | undefined {
  // Common date formats
  const dateRegexes = [
 ...
 */
function getAllText(rootNode: RootNode): string {
  let text = '';
