 ...
 */
export declare function FormatToggle({ currentFormat, onChange, showDescription, showPreview, traditionalLabel, modernLabel, traditionalDescription, modernDescription, className, }: FormatToggleProps): import("react/jsx-runtime").JSX.Element;
