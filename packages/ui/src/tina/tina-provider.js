...
const client = {
    ...
    request: async ({ query, variables }) => {
        console.warn('Mock TinaCMS client is being used. This should be replaced with the actual client.');
        return { data: {} };
    },
    queries: {
        post: {},
...
const TinaCMSContext = createContext(null);
...
export function TinaCMSProvider({ children }) {
    return _jsx(TinaCMSContext.Provider, { value: { client }, children: children });
}
//# sourceMappingURL=tina-provider.js.map