 ...
 */
export declare function EnhancedReaderLayout({ children, paperTitle, sections, currentSectionId, onSectionChange, showHeader, showFooter, showSidePanel, autoHideNavigation, showStickyHeaders, sidePanelContent, headerContent, footerContent, className, }: EnhancedReaderLayoutProps): import("react/jsx-runtime").JSX.Element;
