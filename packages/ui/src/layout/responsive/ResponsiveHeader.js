 ...
 */
export function ResponsiveHeader({ children, autoHide = true, scrollThreshold = 50, className = '', }) {
    ...
    return (_jsx("header", { className: `responsive-header ${isHidden ? 'hidden' : ''} ${className}`, "data-mobile": isMobile, "data-auto-hide": autoHide, children: children }));
}
