...
describe('DynamicSectionTitle', () => {
    ...
    it('renders the provided title', () => {
        render(_jsx(DynamicSectionTitle, { title: "Test Section" }));
        // Check that the title is rendered
        expect(screen.getByText('Test Section')).toBeInTheDocument();
    });
    it('renders default text when title is empty', () => {
        render(_jsx(DynamicSectionTitle, { title: "" }));
    ...
    it('applies animation class when title changes', () => {
        ...
        const { rerender } = render(_jsx(DynamicSectionTitle, { title: "Initial Title" }));
        ...
        // Change the title
        rerender(_jsx(DynamicSectionTitle, { title: "New Title" }));
    ...
    it('does not animate when changing from a title to empty', () => {
        ...
        rerender(_jsx(DynamicSectionTitle, { title: "" }));
    ...
    it('applies custom className correctly', () => {
        render(_jsx(DynamicSectionTitle, { title: "Test Section", className: "custom-class" }));
        // Get the title element
...
//# sourceMappingURL=DynamicSectionTitle.test.js.map