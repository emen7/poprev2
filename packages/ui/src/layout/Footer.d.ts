 ...
 */
export declare function Footer({ leftContent, centerContent, rightContent, fixed, showBorder, className, showShadow, showCopyright, copyrightText, }: FooterProps): import("react/jsx-runtime").JSX.Element;
