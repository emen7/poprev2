 ...
 */
export declare function ReaderHeader({ title, bookNavigationContent, sectionNavigationContent, rightContent, fixed, showBorder, transparentOnTop, showShadow, className, }: ReaderHeaderProps): import("react/jsx-runtime").JSX.Element;
