 ...
 */
export declare function ReaderNavigation({ document, config, activeSection, onSectionSelect, className, onNavigationOpen, onNavigationClose, initiallyOpen, closeOnSelect, }: ReaderNavigationProps): import("react/jsx-runtime").JSX.Element;
