...
export function Reader({ document, config = {}, className = '', style = {} }: ReaderProps) {
  ...
  const readerStyles = {
    ...
    '--reader-font-size': readerConfig.typography.fontSize === 'small' ? '14px'
      : readerConfig.typography.fontSize === 'medium' ? '16px'
      : readerConfig.typography.fontSize === 'large' ? '18px'
      : '20px',
    '--reader-line-height': readerConfig.typography.lineSpacing === 'compact' ? '1.4'
