    ...
    const readerStyles = Object.assign({ 
        ...
        '--reader-font-family': readerConfig.typography.fontFamily ||
            (readerConfig.typography.fontStyle === 'serif'
                ...
                : 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif'), '--reader-font-size': readerConfig.typography.fontSize === 'small'
            ? '14px'
            : readerConfig.typography.fontSize === 'medium'
                ? '16px'
                : readerConfig.typography.fontSize === 'large'
                    ? '18px'
                    : '20px', '--reader-line-height': readerConfig.typography.lineSpacing === 'compact'
            ? '1.4'
            : readerConfig.typography.lineSpacing === 'normal'
                ? '1.6'
                : '1.8', 
        // Layout
        '--reader-max-width': readerConfig.layout.textWidth === 'narrow'
            ? '600px'
