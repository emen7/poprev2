 ...
 */
export declare function NavigationControls({ prevEnabled, nextEnabled, onPrevious, onNext, prevLabel, nextLabel, showLabels, size, className, responsiveCompact, }: NavigationControlsProps): import("react/jsx-runtime").JSX.Element;
