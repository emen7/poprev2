 ...
 */
export declare function SectionNavigator({ sections, currentSectionId, onSectionChange, label, showNumbers, className, closeOnSelect, }: SectionNavigatorProps): import("react/jsx-runtime").JSX.Element;
