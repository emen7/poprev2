...
jest.mock('../BookNavigationPanel', () => ({
  BookNavigationPanel: ({ isOpen }: { isOpen: boolean }) => (
    <div data-testid="book-navigation-panel" data-is-open={isOpen}>
...
jest.mock('../SectionNavigationPanel', () => ({
  SectionNavigationPanel: ({ isOpen }: { isOpen: boolean }) => (
    <div data-testid="section-navigation-panel" data-is-open={isOpen}>
...
jest.mock('../HamburgerButton', () => ({
  HamburgerButton: ({
    ...
    <button
      data-testid={`${variant}-hamburger-button`}
      data-is-open={isOpen}
      onClick={onClick}
    >
      {variant} Hamburger Button
    </button>
  ),
}));
...
describe('DualHamburgerNavigation', () => {
  ...
  it('renders correctly', () => {
    render(<DualHamburgerNavigation />);
  ...
  it('applies custom class name', () => {
    render(<DualHamburgerNavigation className="custom-class" />);

    // Check that the custom class name is applied
    const navigationElement = screen.getByTestId('book-hamburger-button').closest('div')?.parentElement;
