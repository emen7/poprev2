...
export function SectionNavigator({
  ...
  return _jsxs('div', {
    className: `section-navigator ${className}`,
    ref: dropdownRef,
    children: [
      _jsxs('button', {
        ...
        children: [
          _jsxs('span', { className: 'section-navigator-label', children: [label, ':'] }),
          _jsx('span', {
            className: 'section-navigator-current',
              ...
              ? _jsxs(_Fragment, {
                  children: [
                    showNumbers &&
                      ...
                      _jsx('span', {
                        className: 'section-navigator-number',
                        children: currentSection.number,
                      }),
                    _jsx('span', {
                      className: 'section-navigator-title',
                      children: currentSection.title,
                    }),
                  ],
                })
              : _jsx('span', {
                  className: 'section-navigator-placeholder',
                  children: 'Select a section',
                }),
          }),
          _jsx('span', { className: 'section-navigator-arrow' }),
        ],
      }),
      isOpen &&
        _jsx('div', {
          ...
          children: sections.map(section =>
            _jsxs(
              'div',
              {
                className: `section-navigator-item ${section.id === currentSectionId ? 'section-navigator-item-active' : ''}`,
                ...
                children: [
                  showNumbers &&
                    section.number &&
                    _jsx('span', {
                      className: 'section-navigator-item-number',
                      children: section.number,
                    }),
                  _jsx('span', {
                    className: 'section-navigator-item-title',
