...
export function StickyHeadersContainer({
  ...
  return _jsxs('div', {
    className: `sticky-headers-container ${className}`,
    children: [
      _jsx('div', {
        className: `sticky-paper-title ${isScrolled ? 'scrolled' : ''}`,
        children: paperTitle,
      }),
      activeSection &&
        _jsx('div', { className: 'sticky-section-header', children: activeSection.title }),
      _jsx('div', {
