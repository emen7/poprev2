...
export function SectionNavigationPanel({ isOpen, className = '' }) {
    ...
    const paperTitle = currentPaperId === 'paper1'
            ...
            : currentPaperId === 'paper3'
                ...
                : currentPaperId === 'paper4'
                    ...
                    : currentPaperId === 'paper5'
                        ...
                        : 'Current Paper';
    return (_jsxs("nav", { className: panelClasses, "aria-hidden": !isOpen, children: [_jsxs("div", { className: styles.header, children: [_jsx("h2", { className: styles.title, children: paperTitle }), _jsx("button", { className: styles.closeButton, onClick: toggleSectionNav, "aria-label": "Close section navigation", children: "\u00D7" })] }), _jsx("ul", { className: styles.navigationList, children: sections.map(section => (_jsx("li", { className: styles.navigationItem, children: _jsx("a", { href: `#${section.id}`, className: `${styles.navigationLink} ${section.id === currentSectionId ? styles.active : ''}`, onClick: e => {
                            e.preventDefault();
