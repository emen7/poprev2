...
export function DualHamburgerNavigation({ className = '' }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: `${styles.dualHamburgerNavigation} ${className}`, children: _jsxs("div", { className: styles.buttonContainer, children: [_jsx(HamburgerButton, { variant: "book", isOpen: isBookNavOpen, onClick: toggleBookNav }), _jsx(HamburgerButton, { variant: "section", isOpen: isSectionNavOpen, onClick: toggleSectionNav })] }) }), _jsx(BookNavigationPanel, { isOpen: isBookNavOpen }), _jsx(SectionNavigationPanel, { isOpen: isSectionNavOpen }), _jsx("div", { className: `${styles.overlay} ${isBookNavOpen || isSectionNavOpen ? styles.overlayVisible : ''}`, onClick: handleOverlayClick, "aria-hidden": "true" })] }));
}
