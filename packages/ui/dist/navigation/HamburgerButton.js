...
export function HamburgerButton({
  ...
  return _jsxs('button', {
    ...
    type: 'button',
    children: [
      _jsx('span', { className: 'hamburger-line hamburger-line-1' }),
      _jsx('span', { className: 'hamburger-line hamburger-line-2' }),
      _jsx('span', { className: 'hamburger-line hamburger-line-3' }),
    ],
  });
}
