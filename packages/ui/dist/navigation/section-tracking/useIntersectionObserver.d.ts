 ...
 */
export declare function useIntersectionObserver<T extends Element>(options?: IntersectionObserverOptions, onIntersect?: (entry: IntersectionObserverEntry) => void): [RefObject<T>, boolean];
