...
export function SearchFilters({ className = '' }) {
  ...
  useEffect(() => {
    const types =
      (searchParams === null || searchParams === void 0 ? void 0 : searchParams.getAll('type')) ||
      [];
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('h3', { className: 'text-sm font-medium', children: 'Document Types' }),
      _jsx('div', {
        className: 'space-y-2',
          ...
          _jsxs(
            'label',
            {
              ...
              children: [
                ...
                _jsx('span', { className: 'ml-2 text-sm', children: option.label }),
              ],
            },
            option.value
          )
