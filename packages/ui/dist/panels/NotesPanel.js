    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('button', { className: 'notes-add-button', onClick: addNote, children: 'Add Note' }),
        ],
      }),
      _jsx('div', {
            ...
            : notes.map(note =>
                _jsx(
                  'div',
                  {
                    className: 'note-item',
                    children:
                      (currentNote === null || currentNote === void 0 ? void 0 : currentNote.id) ===
                      note.id
                        ? _jsxs('div', {
                            ...
                            children: [
                              _jsx('textarea', {
                                ...
                                onChange: e =>
                                  setCurrentNote(
                                    Object.assign(Object.assign({}, currentNote), {
                        ...
                        : _jsxs(_Fragment, {
                            children: [
                              _jsx('div', { className: 'note-content', children: note.content }),
                              _jsxs('div', {
                                className: 'note-meta',
                                children: [
                                  _jsx('span', {
