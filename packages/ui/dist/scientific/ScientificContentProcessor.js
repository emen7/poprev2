...
export function processScientificContent(content, tooltipData, options = {}) {
    ...
    Object.entries(tooltipData).forEach(([term, data]) => {
        ...
        if ((data.type === 'abbreviation' && !mergedOptions.processAbbreviations) ||
...
function positionTooltip(targetElement, tooltipElement, position = 'auto') {
    ...
    tooltipElement.classList.remove('tooltip-position-top', 'tooltip-position-bottom', 'tooltip-position-left', 'tooltip-position-right');
