 ...
 */
export declare function ScientificContentProvider({ initialData, dataUrl, includeExampleData, persistData, children, }: ScientificContentProviderProps): import("react/jsx-runtime").JSX.Element;
/**
