...
export function ReaderLayout({
  ...
  return _jsxs('div', {
    className: `reader-layout ${className}`,
    children: [
      showHeader && _jsx('header', { className: 'reader-layout-header', children: headerContent }),
      _jsxs('div', {
      ...
      showFooter && _jsx('footer', { className: 'reader-layout-footer', children: footerContent }),
