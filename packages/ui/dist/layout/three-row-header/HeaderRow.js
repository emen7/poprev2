...
export function HeaderRow({ rowType, leftContent, centerContent, rightContent, className = '' }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', { className: styles.leftContent, children: leftContent }),
      _jsx('div', { className: styles.centerContent, children: centerContent }),
      _jsx('div', { className: styles.rightContent, children: rightContent }),
    ],
  });
}
