...
export function ThreeRowHeader({ paperTitle, className = '' }) {
  ...
  return _jsxs('header', {
    className: `${styles.threeRowHeader} ${className}`,
    children: [
      _jsx(HeaderRow, {
        rowType: 'top',
        leftContent: _jsx(DualHamburgerNavigation, {}),
        centerContent: _jsx('h1', { className: styles.mainTitle, children: 'Urantia Book' }),
      }),
      _jsx(HeaderRow, {
        rowType: 'paper',
        centerContent: _jsx('h2', { className: styles.paperTitle, children: paperTitle }),
      }),
      _jsx(HeaderRow, {
        rowType: 'section',
        centerContent: _jsx(DynamicSectionTitle, {
