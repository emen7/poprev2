 ...
 */
export function ResponsiveFooter({ children, autoHide = true, scrollThreshold = 50, className = '', }) {
    ...
    return (_jsx("footer", { className: `responsive-footer ${isHidden ? 'hidden' : ''} ${className}`, "data-mobile": isMobile, "data-auto-hide": autoHide, children: children }));
}
