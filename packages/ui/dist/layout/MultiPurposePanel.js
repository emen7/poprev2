      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('div', {
            ...
            children: _jsx('div', { className: 'resize-handle-bar' }),
          }),
          tabs.length > 0
            ? _jsxs('div', {
                className: 'multi-purpose-panel-tabs',
                children: [
                  _jsx('div', {
                    ...
                    children: tabs.map(tab =>
                      _jsxs(
                        'button',
                        {
                          ...
                          children: [
                            tab.icon && _jsx('span', { className: 'tab-icon', children: tab.icon }),
                            _jsx('span', { className: 'tab-label', children: tab.label }),
                          ],
                        },
                        tab.id
                      )
            ...
            : _jsx('div', { className: 'multi-purpose-panel-content', children: children }),
        ],
      }),
    ],
  });
