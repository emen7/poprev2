...
export function DocumentReader({ document }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        className: 'document-reader-header',
        children: [
          _jsx('h1', {
            className: 'document-title',
            children: document.metadata.title || 'Untitled Document',
          }),
          document.metadata.subtitle &&
            _jsx('h2', { className: 'document-subtitle', children: document.metadata.subtitle }),
          _jsxs('div', {
            ...
            children: [
              ...
              document.metadata.date &&
                _jsx('div', { className: 'document-date', children: document.metadata.date }),
              document.metadata.categories &&
                document.metadata.categories.length > 0 &&
                _jsxs('div', {
                  className: 'document-categories',
                  children: ['Categories: ', document.metadata.categories.join(', ')],
                }),
              document.metadata.tags &&
                document.metadata.tags.length > 0 &&
                _jsxs('div', {
                  className: 'document-tags',
                  children: ['Tags: ', document.metadata.tags.join(', ')],
                }),
            ],
          }),
        ],
      ...
      tableOfContents.length > 0 &&
        _jsxs('div', {
          ...
          children: [
            _jsx('h3', { children: 'Table of Contents' }),
            _jsx('ul', {
              children: tableOfContents.map((item, index) =>
                _jsx(
                  'li',
                  {
      ...
      _jsx('div', { className: 'document-content', children: renderContent(document.content) }),
    ],
  });
}
/**
...
function renderContent(rootNode) {
  ...
  return _jsx(_Fragment, {
    children: children.map((node, index) =>
      _jsx(React.Fragment, { children: renderNode(node) }, index)
    ),
  });
}
/**
...
function renderNode(node) {
  switch (node.type) {
    ...
    case 'list':
      return node.ordered
        ? _jsx('ol', { className: 'document-ordered-list', children: renderChildren(node) })
        : _jsx('ul', { className: 'document-unordered-list', children: renderChildren(node) });
    case 'listItem':
    ...
    case 'code':
      return _jsx('pre', {
        ...
        children: _jsx('code', {
          ...
          children: node.value || renderChildren(node),
        }),
      });
    case 'inlineCode':
      return _jsx('code', {
        className: 'document-inline-code',
        children: node.value || renderChildren(node),
      });
    case 'emphasis':
    ...
    case 'table':
      return _jsx('div', {
        className: 'document-table-container',
        children: _jsx('table', {
          className: 'document-table',
          children: _jsx('tbody', { children: renderChildren(node) }),
        }),
      });
    case 'tableRow':
...
function renderChildren(node) {
  ...
  return _jsx(_Fragment, {
    children: node.children.map((child, index) =>
      _jsx(React.Fragment, { children: renderNode(child) }, index)
    ),
  });
}
