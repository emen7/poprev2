...
export function EnhancedReaderDemo() {
  ...
  const headerContent = _jsxs('div', {
    className: 'demo-header-content',
    children: [
      _jsx('h1', { className: 'demo-header-title', children: 'UB Reader' }),
      _jsx(NavigationControls, {
  ...
  const footerContent = _jsxs('div', {
    className: 'demo-footer-content',
    children: [
      _jsx('div', {
        className: 'demo-footer-info',
        children: _jsx('span', { children: '\u00A9 2025 UB Ecosystem' }),
      }),
      _jsxs('div', {
        className: 'demo-footer-controls',
        children: [
          _jsx('button', { className: 'demo-footer-button', children: 'A-' }),
          _jsx('button', { className: 'demo-footer-button', children: 'A+' }),
          _jsx('button', { className: 'demo-footer-button', children: '\u2630' }),
        ],
      }),
    ],
  });
  // Create side panel content
  const sidePanelContent = _jsx('div', {
  ...
  return _jsx(EnhancedReaderLayout, {
    paperTitle: _jsx('h1', { className: 'demo-paper-title', children: paper.title }),
    ...
    children: _jsx('div', {
      ...
      children: paper.sections.map(section =>
        _jsxs(
          'div',
          {
            id: section.id,
            ...
            children: [
              _jsx('h2', { className: 'demo-section-title', children: section.title }),
              _jsx('div', {
