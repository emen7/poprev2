...
export function ReaderDemo() {
    ...
    children: [
      ...
      _jsxs('p', {
        children: [
          ...
          _jsx(ScientificTooltip, { content: 'DNA', data: exampleTooltipData['DNA'] }),
          'and',
          _jsx(ScientificTooltip, { content: 'RNA', data: exampleTooltipData['RNA'] }),
  ...
  const bottomPanelTabs = [
    ...
    },
    {
      ...
      label: 'References',
      content: _jsxs('div', {
        className: 'references-placeholder',
        children: [
          _jsx('h3', { children: 'References' }),
          _jsx('p', { children: 'This is a placeholder for the References panel.' }),
          _jsxs('ul', {
            children: [
              _jsx('li', {
                children: 'Einstein, A. (1905). "On the Electrodynamics of Moving Bodies"',
              }),
              _jsx('li', {
                children: 'Feynman, R. (1985). "QED: The Strange Theory of Light and Matter"',
              }),
              _jsx('li', {
                children: 'Watson, J. & Crick, F. (1953). "Molecular Structure of Nucleic Acids"',
              }),
            ],
          }),
        ],
    ...
    },
    {
      ...
      label: 'Glossary',
      content: _jsxs('div', {
        className: 'glossary-placeholder',
        children: [
          _jsx('h3', { children: 'Glossary' }),
          _jsx('p', { children: 'This is a placeholder for the Glossary panel.' }),
          _jsxs('dl', {
            children: [
              _jsx('dt', { children: 'Quantum Mechanics' }),
              _jsx('dd', {
                children:
              ...
              _jsx('dt', { children: 'Relativity' }),
              _jsx('dd', {
                children:
                  'A theory developed by Albert Einstein that describes the relationship between space and time, and how gravity affects them.',
              }),
              _jsx('dt', { children: 'Molecular Biology' }),
              _jsx('dd', {
                children:
  ...
  // Header content
  const headerContent = _jsx(Header, {
    leftContent: _jsx('button', {
      onClick: () => console.log('Back button clicked'),
      children: 'Back',
    }),
    centerContent: _jsx('h1', { children: 'Enhanced Reader Demo' }),
  });
  // Footer content
  const footerContent = _jsx(Footer, {
    ...
    centerContent: _jsxs('div', {
      ...
      children: [
        ...
        _jsx('a', { href: '#', children: 'Help' }),
      ],
    }),
  });
  return _jsx(ScientificContentProvider, {
    initialData: exampleTooltipData,
    includeExampleData: true,
    children: _jsx(ReaderLayout, {
      showHeader: true,
      showFooter: true,
