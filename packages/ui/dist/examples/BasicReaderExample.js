...
export function BasicReaderExample() {
  ...
  return _jsxs('div', {
    className: 'basic-reader-example',
    children: [
      _jsxs('div', {
        className: 'reader-controls',
        children: [
          _jsx('h2', { children: 'Reader Controls' }),
          _jsxs('div', {
            className: 'control-group',
            children: [
              _jsxs('button', {
                onClick: toggleFormat,
                children: ['Format: ', formatType === 'traditional' ? 'Traditional' : 'Modern'],
              }),
              _jsxs('button', {
                onClick: toggleNumbers,
                children: ['Numbers: ', showNumbers ? 'On' : 'Off'],
              }),
            ],
          }),
          _jsxs('div', {
            className: 'control-group',
            children: [
              _jsx('h3', { children: 'Highlight Sections' }),
          ...
          _jsxs('div', {
            className: 'control-group',
            children: [
              _jsx('h3', { children: 'Highlight Paragraphs' }),
              _jsx('button', {
