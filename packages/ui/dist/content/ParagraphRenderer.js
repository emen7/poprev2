 ...
 */
export const ParagraphRenderer = forwardRef(function ParagraphRenderer(
  {
    paragraph,
    formatType,
    showNumber = true,
  ...
  if (isList && listType === 'numbered') {
    return _jsxs('div', {
      ...
      children: [
        showNumber &&
          _jsx('span', { className: 'paragraph-number', children: paragraphNumberOnly }),
        _jsxs('div', {
          className: 'paragraph-text',
          children: [
            _jsxs('span', { className: 'list-number', children: [number, '.'] }),
            ' ',
            _jsx('span', { dangerouslySetInnerHTML: { __html: text } }),
          ],
        }),
      ],
    });
    ...
    return _jsxs('div', {
      ...
      children: [
        ...
        _jsxs('div', {
          className: 'paragraph-text',
          children: [
            _jsx('span', { className: 'list-bullet', children: '\u2022' }),
            ' ',
            _jsx('span', { dangerouslySetInnerHTML: { __html: text } }),
          ],
        }),
    ...
    return _jsxs('div', {
      ...
      children: [
        showNumber &&
          _jsx('span', { className: 'paragraph-number', children: paragraphNumberOnly }),
        _jsx('div', { className: 'paragraph-text', dangerouslySetInnerHTML: { __html: text } }),
      ],
    });
  }
});
