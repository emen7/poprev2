 ...
 */
export const SectionRenderer = forwardRef(function SectionRenderer(
  {
    section,
    formatType,
  ...
  return _jsxs('section', {
    ...
    children: [
      _jsxs('h2', {
        ...
        children: [
          number && _jsxs('span', { className: 'section-number', children: [number, '.'] }),
          _jsx('span', { className: 'section-title-text', children: title }),
        ],
      }),
      _jsx('div', {
