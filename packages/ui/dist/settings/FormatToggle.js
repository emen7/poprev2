...
export function FormatToggle({
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', {
        className: 'format-toggle-header',
        children: _jsx('h3', { className: 'format-toggle-title', children: 'Content Formatting' }),
      }),
      _jsxs('div', {
        className: 'format-toggle-options',
        children: [
          _jsxs('div', {
            className: `format-option ${currentFormat === 'traditional' ? 'format-option-active' : ''}`,
            onClick: () => handleFormatChange('traditional'),
            children: [
              _jsxs('div', {
                className: 'format-option-header',
                children: [
                  _jsx('input', {
                    type: 'radio',
                  ...
                  _jsx('label', {
                    ...
                    className: 'format-option-label',
                    children: traditionalLabel,
                  }),
                ],
              }),
              showDescription &&
                _jsx('p', {
                  className: 'format-option-description',
                  children: traditionalDescription,
                }),
              showPreview &&
                _jsx('div', {
                  className: 'format-preview format-preview-traditional',
                  children: _jsxs('div', {
                    className: 'format-preview-paragraph',
                    children: [
                      _jsx('span', { className: 'format-preview-number', children: '1' }),
                      _jsxs('span', {
                        className: 'format-preview-text',
                        children: [
                          'This is an example of ',
                          _jsx('em', { children: 'traditional' }),
                          ' formatting with standard emphasis.',
                        ],
                      }),
                    ],
                  }),
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx('label', {
                    htmlFor: 'format-modern',
                    className: 'format-option-label',
                    children: modernLabel,
                  }),
                ],
              }),
              showDescription &&
                _jsx('p', { className: 'format-option-description', children: modernDescription }),
              showPreview &&
                _jsx('div', {
                  className: 'format-preview format-preview-modern',
                  children: _jsxs('div', {
                    className: 'format-preview-paragraph',
                    children: [
                      _jsx('span', { className: 'format-preview-number', children: '1' }),
                      _jsxs('span', {
                        ...
                        children: [
                          'This is an example of ',
                          _jsx('em', { children: 'modern' }),
                          ' formatting with enhanced emphasis.',
                        ],
                      }),
                    ],
                  }),
